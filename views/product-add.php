    ...
    <div class="container py-4">
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-body d-flex flex-wrap justify-content-between align-items-center">
                <div>
                    <h1 class="h3 mb-1">Them san pham</h1>
                    <div class="text-muted">Nhap thong tin de tao san pham moi.</div>
                </div>
        ...
        <div class="card shadow-sm border-0">
            <div class="card-body">
                <form method="post" action="index.php?page=product-store" class="row g-3">
                    <div class="col-12">
